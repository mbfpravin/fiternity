			...
			value: function initEvents() {
				...
				this.mouseenterFn = function () {
					return _this.mouseTimeout = setTimeout(function () {
						...
						anime({
							...
							translateY: [{ value: function value(t, i) {
									return i % 2 === 0 ? 10 : -10;
								}, duration: duration, easing: 'easeInSine' }, { value: function value(t, i) {
									return i % 2 === 0 ? [-10, 0] : [10, 0];
								}, duration: duration + 700, easing: 'easeOutElastic', elasticity: 600 }],
							opacity: [{ value: 0, duration: duration, easing: 'linear' }, { value: 1, duration: duration, easing: 'linear' }],
							color: {
								value: _this.colors.active,
								duration: 1,
								delay: function delay(t, i) {
									return i * 20 + duration;
								},
								easing: 'linear'
							}
						});
				...
				this.mouseleaveFn = function () {
					...
					anime({
						...
						opacity: [{ value: 0, duration: duration, easing: 'linear' }, { value: 1, duration: duration, easing: 'linear' }],
						color: {
							value: _this.colors.initial,
							duration: 1,
							delay: function delay(t, i, l) {
								return (l - i - 1) * 20 + duration;
							},
							easing: 'linear'
						}
					});
...
var app = function () {
  ...
  var init = function init() {
    ...
    var outerWidth = (windowWidth - containerWidth) / 2;
    $('#eventSlider').css({ width: outerWidth + containerWidth });
  ...
  _loader = function _loader() {
    ...
    NProgress.start();
      ...
      _floatTrigger = function _floatTrigger() {
    $('.float-tigger').on('click', function () {
      $('.float-form').toggleClass('active');
    });
  },
      _menuToggle = function _menuToggle() {
    $('.menu-toggle').on('click', function () {
      $(this).toggleClass('on');
      $('nav').toggleClass('slide');
    });
  },
      _bannerSlider = function _bannerSlider() {
    $('.slider').slick({
      arrows: true,
      infinite: true,
      speed: 500,
      ...
      slidesToScroll: 1,
      dots: false,
      prevArrow: '<div class="slick-prev"><span class="fa fa-angle-left"></div>',
      nextArrow: '<div class="slick-next"><span class="fa fa-angle-right"></div>',
      responsive: [{
        breakpoint: 1000,
        settings: {
          arrows: false,
      ...
      _cardEqualHeight = function _cardEqualHeight() {
    $('.col-4 .whitebox').matchHeight();
    $('.slider-blk .whitebox').matchHeight();
  },
      _mobileMenu = function _mobileMenu() {
    ...
    $('.parallaxBg').each(function () {
      $(this).attr('id', 'parallX' + idCount);
      $('#' + 'parallX' + idCount).parallax("center", 0.4);
      idCount++;
    });
  },
    ...
    $('.accordion h5').on('click', function () {
      ...
      _fileBrowes = function _fileBrowes() {
    $(".file-upload").change(function () {
      var x = $(".file-upload").val();
      $('#file-upload-value').val(x);
    });
  },
      _formElements = function _formElements() {
    ...
    window.rippler = $.ripple('.button', '.subBtn', {
      debug: true,
      multi: true,
      opacity: 0.15,
      color: "auto",
    ...
    $(".tabs-menu a").on('click', function (event) {
      ...
      $(tab).fadeIn();
      $('.slider-nav-tab').slick('refresh');
      $('.image-slider').slick('refresh');
    });

    //magnific zoom in and out
    ...
    //auto search
    var languages = ["Events", "Think", "Offers", "About", "Contact", "Life", "Move", "Fuel", "Events", "Think", "Offers", "About", "Contact", "Life", "Move", "Fuel"];
    $("#tags").autocomplete({
      source: languages
    });
    ...
    $(window).scroll(function () {
      ...
      if (scroll > 450) sticky.addClass('fixed');else sticky.removeClass('fixed');
    });
  },
      _thumSlider = function _thumSlider() {
    var _$$slick;
    ...
    $('.slider-nav-tab').slick((_$$slick = {
      ...
      focusOnSelect: true,
      vertical: true
    }, _defineProperty(_$$slick, 'dots', false), _defineProperty(_$$slick, 'arrows', false), _defineProperty(_$$slick, 'centerMode', false), _defineProperty(_$$slick, 'responsive', [{
      breakpoint: 769,
      settings: {
        slidesToShow: 1,
        slidesToScroll: 1,
      ...
      responsiveView = function responsiveView() {
    // equal height rows
    var highestBox = 0;
    var highestBox1 = 0;
    $('.col-4 .whitebox').matchHeight();
...
$(window).on('load', function () {
  if (sessionStorage.getItem('loader') == null) {
    setTimeout(function () {
      $('.render-blk').animate({ opacity: 1 }, 1000, function () {
        NProgress.done();
        $('.intro-hero-banner-content').fadeIn(1000, function () {
    ...
    $('.render-blk, header').animate({ opacity: 1 }, 1000, function () {
      NProgress.done();
    });
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["anime"] = __webpack_require__(21);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["charming"] = __webpack_require__(22);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jqueryMagnificPopup"] = __webpack_require__(24);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jqueryParallax"] = __webpack_require__(26);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jqueryUi"] = __webpack_require__(23);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ripple"] = __webpack_require__(27);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["slick"] = __webpack_require__(25);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["slick"] = __webpack_require__(28);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = global["window"]["Tether"] = __webpack_require__(32);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
"use strict";
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/*! jQuery UI - v1.12.0 - 2016-07-08
* http://jqueryui.com
...
(function ($) {
	...
	$.fn.parallax = function (xpos, speedFactor, outerHeight) {
		...
		$('.intro-hero-banner').scroll(function () {
			update();
		});
...
!function (a, b, c) {
  a.ripple = function (d, e) {
    ...
    };f.selector = d, f.defaults = { debug: !1, on: "mousedown", opacity: .4, color: "auto", multi: !1, duration: .7, rate: function rate(a) {
        return a;
      }, easing: "linear" }, f.defaults = a.extend({}, f.defaults, e);var h = function h(b) {
      var d,
          e,
          h = a(this);if (h.addClass("has-ripple"), e = a.extend({}, f.defaults, h.data()), e.multi || !e.multi && 0 === h.find(".ripple").length) {
        if (d = a("<span></span>").addClass("ripple"), d.appendTo(h), g("Create: Ripple"), !d.height() && !d.width()) {
          var i = c.max(h.outerWidth(), h.outerHeight());d.css({ height: i, width: i }), g("Set: Ripple size");
        }if (e.rate && "function" == typeof e.rate) {
          var j = c.round(d.width() / e.duration),
              k = e.rate(j),
              l = d.width() / k;e.duration.toFixed(2) !== l.toFixed(2) && (g("Update: Ripple Duration", { from: e.duration, to: l }), e.duration = l);
        }var m = "auto" == e.color ? h.css("color") : e.color,
            n = { animationDuration: e.duration.toString() + "s", animationTimingFunction: e.easing, background: m, opacity: e.opacity };g("Set: Ripple CSS", n), d.css(n);
      }e.multi || (g("Set: Ripple Element"), d = h.find(".ripple")), g("Destroy: Ripple Animation"), d.removeClass("ripple-animate");var o = b.pageX - h.offset().left - d.width() / 2,
          p = b.pageY - h.offset().top - d.height() / 2;e.multi && (g("Set: Ripple animationend event"), d.one("animationend webkitAnimationEnd oanimationend MSAnimationEnd", function () {
        g("Note: Ripple animation ended"), g("Destroy: Ripple"), a(this).remove();
      })), g("Set: Ripple location"), g("Set: Ripple animation"), d.css({ top: p + "px", left: o + "px" }).addClass("ripple-animate");
...
//////////////////////////////////////////
var requireSCSS = __webpack_require__(20);
